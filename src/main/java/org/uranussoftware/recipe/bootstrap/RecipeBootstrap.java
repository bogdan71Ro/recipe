package org.uranussoftware.recipe.bootstrap;

import lombok.extern.slf4j.Slf4j;
import org.springframework.transaction.annotation.Transactional;
import org.uranussoftware.recipe.domain.*;
import org.uranussoftware.recipe.repositories.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    /*
       The @Transactional annotation below FORCES onApplicationEvent to open its own Hibernate transaction.
       This avoids LazyInitializationErrors to produce just because of some thread condition problems.
     */
    @Override
    @Transactional
    ...
    private List<Recipe> getRecipes() {
        ...
        log.debug("Recipe Bootstrap: started.");

        List<Recipe> recipes = new ArrayList<>(2);

        log.debug("Recipe Bootstrap: adding Units of Measure.");
        ...
        log.debug("Recipe Bootstrap: adding Categories.");
        //get Categories
        ...
        //Yummy Guac
        log.debug("Building GUAC Recipe...");
        ...
        //Yummy Tacos
        log.debug("Building Tacos Recipe...");
        ...
        log.debug("Recipe Bootstrap: finished.");
        return recipes;
    }
}
